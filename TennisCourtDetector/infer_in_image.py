...
#this function does not make use of batching. Which would have to be addressed for optimization
def get_points(image: np.ndarray, model:BallTrackerNet):
    OUTPUT_WIDTH = 640
    OUTPUT_HEIGHT = 360
    ...
    # the code below was present in the original repository. It marks every court intersection with 
    # a red circle as a new image
...
#this part was already present in the repo. I used its logic to write the above code
